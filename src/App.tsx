...
const data: Item[] = [
  ...
  {
    question:
      "Which statement is used to exit or end a loop prematurely in JavaScript?",
  ...
  },
  {
    ...
    options: ['int("42")', 'parseInt("42")', 'toInt("42")', '"42".toInteger()'],
    answer: 1,
  },
];
...
function App() {
  ...
  return (
    <div className="w-full flex pt-[10vh] lg:pt-[16vh] h-screen">
      ...
      <div className="max-w-4xl overflow-hidden left-1/2 -translate-x-1/2 absolute px-4 w-full top-1/2 text-white">
        <AnimatePresence>
          {question && (
            <motion.div
